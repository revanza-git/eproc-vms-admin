...
class Utility
{
	...
	function drop_down_paging($name = '', $value = '', $java = '')
	{
		...
		foreach ($array as $data) {
			if ($value == $data) $sel = " selected='selected' ";
			else $sel = "";
	...
	public function mail($to, $message, $subject)
	{
		$config = array(
			'protocol' 	=> 'smtp',
		...
		$this->CI->email->bcc('dzikrul65@gmail.com');
		// $this->CI->email->cc('dzikrul65@gmail.com');muarifgustiar@gmail.com,
	...
	function mail_($to, $message, $subject)
	{
		$to = base64_encode($to);
