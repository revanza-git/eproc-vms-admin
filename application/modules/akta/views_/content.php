	...
	<table class="tableData">
		...
		<thead>
			...
			<tr>
				...
				<td><a href="?<?php echo $this->utility->generateLink('sort','desc')?>&sort=<?php echo ($sort['authorize_file'] == 'asc') ? 'desc' : 'asc'; ?>&by=authorize_file">Lampiran Bukti Perpanjangan<i class="fa fa-sort-<?php echo ($sort['file_extension_akta'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
