<div class="sideArea">
	<div class="loginInfo">
        ...
        <li><a href="#">Reporting</a> <i class="fa fa-chevron-down li-icon"></i>
            <ul class="navMenuDD">
        ...
        <li><a href="<?php echo site_url('admin/app')?>">Ke aplikasi Perencanaan</a><i class="fa fa-sign-out li-icon"></i></li>
        <?php }?> 
