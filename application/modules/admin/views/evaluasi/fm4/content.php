...
<div class="btnTopGroup clearfix">
	<!-- <a href="<?php echo site_url('admin/admin_evaluasi_fm4/tambah') ?>" class="btnBlue"><i class="fa fa-plus"></i>Tambah</a> -->
</div>
			...
			?>
					<tr>
						...
						<td class="actionBlock">
							<a href="<?php echo site_url('admin/admin_evaluasi_fm4/edit/' . $value['id']) ?>" class="editBtn"><i class="fa fa-cog"></i>Edit</a>
							<a style="top: -4px" href="<?php echo site_url('admin/admin_evaluasi_fm4/hapus/' . $value['id']) ?>" class="delBtn"><i class="fa fa-trash"></i>Hapus</a>
						</td>
					</tr>
				<?php
				}
