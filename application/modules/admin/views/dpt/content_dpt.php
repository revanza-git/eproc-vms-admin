	...
	<table class="tableData">
		<thead>
			<tr>
				...
				<td><a href="?<?php echo $this->utility->generateLink('sort', 'desc') ?>&sort=<?php echo ($sort['dpt_first_date'] == 'asc') ? 'desc' : 'asc'; ?>&by=dpt_first_date">Tanggal Pengangkatan Awal<i class="fa fa-sort-<?php echo ($sort['dpt_first_date'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
				<td><a href="?<?php echo $this->utility->generateLink('sort', 'desc') ?>&sort=<?php echo ($sort['start_date'] == 'asc') ? 'desc' : 'asc'; ?>&by=start_date">Tanggal Pengangkatan Terakhir<i class="fa fa-sort-<?php echo ($sort['start_date'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
