...
class Admin_evaluasi_fm4 extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('evaluasi/evaluasi_fm4_model', 'em');
    }
    ...
    public function index()
    {
        ...
        $layout['content']    = $this->load->view('evaluasi/fm4/content', $data, TRUE);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($res) {
                ...
                redirect(site_url('admin/admin_evaluasi_fm4'));
            }
        }

        $layout['content']    = $this->load->view('evaluasi/fm4/tambah', $data, TRUE);
    ...
    function edit($id)
    {
        ...
        $layout['content']    = $this->load->view('evaluasi/fm4/edit', $data, TRUE);
