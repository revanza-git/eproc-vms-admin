    ...
    ?>
			...
			<tr class="input-form">
				...
				<td><div style="overflow: hidden;">
					<label class="lbform">
						<?php echo form_radio(array('name'=>'vendor_office_status'),'pusat',set_radio('vendor_office_status','pusat')||(($this->form->get_temp_data('vendor_office_status'))?$this->form->get_temp_data('vendor_office_status'):$vendor_office_status)=='pusat')?>Pusat
					</label>
					<label class="lbform">
						<?php echo form_radio(array('name'=>'vendor_office_status'),'cabang',set_radio('vendor_office_status','cabang')||(($this->form->get_temp_data('vendor_office_status'))?$this->form->get_temp_data('vendor_office_status'):$vendor_office_status)=='cabang')?>Cabang
					</label></div>
