...
<div class="formDashboard">
	<h1 class="formHeader">Pengadaan</h1>
		...
		<div class="buttonRegBox clearfix">
			...
			<a href="<?php echo site_url('pengadaan/edit/'.$id);?>" class="btnBlue"><i class='fa fa-cog'></i>&nbsp;Ubah</a>

			<a href="<?php echo site_url('pengadaan/reset/'.$id);?>" class="btnBlue"><i class='fa fa-undo'></i>&nbsp;Reset</a>
			<?php } ?>
		</div>
