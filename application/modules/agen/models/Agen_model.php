...
class Agen_model extends CI_Model{
	...
	public function get_agen_list($search='', $sort='', $page='', $per_page='',$is_page=FALSE,$filter=array()) 
    {
	...
	public function get_produk_list($id, $search='', $sort='', $page='', $per_page='',$is_page=FALSE) 
    {
	...
	public function edit_data_produk($data,$id){
  ...
  return null;
	...
	public function get_agen_admin_list($id) 
    {
    	$this->session->userdata('user');
		$this->db->select('*');
    ...
    public function get_produk_admin_list($id_data,$id) 
    {
    	$this->session->userdata('user');
		$this->db->select('*');
		$this->db->where('ms_agen_produk.del',0);
