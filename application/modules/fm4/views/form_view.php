		...
		<form method="POST" enctype="multipart/form-data">
			<table>
				<tr class="input-form ">
					...
					<td>: <?php if (isset($csms_file['csms_file']['csms_file'])) { ?><a href="<?php echo base_url('lampiran/csms_file/' . $csms_file['csms_file']['csms_file']); ?>" target="_blank">Lampiran</a><?php } else {
																																																			echo "-";
																																																		} ?>
														...
														<?php foreach ($valueq as $keydata => $valuedata) { ?>
															...
															switch ($valuedata['type']) {
																...
																case 'file':
																	if (isset($data_k3[$keydata]['value'])) {
																		if ($data_k3[$keydata]['value'] != '') {
																			echo '<p><a href="' . base_url('lampiran/csms_file/' . $field_quest[$keydata]['label'] . '/' . $data_k3[$keydata]['value']) . '" target="_blank">Lampiran</a></p>';
																		} else {
																			echo '-';
																		}
																	} else {
