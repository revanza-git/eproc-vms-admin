...
class blacklist_model extends CI_Model{
	...
	public function blacklist_data($id_blacklist){
  ...
  return null;
	...
	public function get_blacklist_data($id_vendor){
	...
	public function get_blacklist_by_vendor($id){
		$query = 	"	SELECT
							*
						FROM 
							tr_blacklist a
	...
	public function get_blacklist_list($id, $search='', $sort='', $page='', $per_page='',$is_page=FALSE,$filter=array()){
  ...
  return false;
	...
	public function whitelist_data(){
	...
	public function get_admin_email($id_role){
		$query ="	SELECT
							email
						FROM
							ms_admin
	...
	public function approve_white($data){
