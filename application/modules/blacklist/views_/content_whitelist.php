...
<a style="background: #2f3640 !important; border-bottom: 2px #718093 solid !important;" href="<?php echo site_url('blacklist/export_whitelist/');?>" class="btnBlue"><i class="fa fa-download"></i> Export</a>
		<form method="POST">
	...
	<table class="tableData remark">
		...
		<thead>
			...
			<tr>
				...
				<td><a href="?<?php echo $this->utility->generateLink('sort','desc')?>&sort=<?php echo ($sort['id_vendor'] == 'asc') ? 'desc' : 'asc'; ?>&by=id_vendor">Penyedia Barang &amp; Jasa<i class="fa fa-sort-<?php echo ($sort['id_vendor'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>

				<td><a href="?<?php echo $this->utility->generateLink('sort','desc')?>&sort=<?php echo ($sort['white_date'] == 'asc') ? 'desc' : 'asc'; ?>&by=white_date">Tanggal Pemutihan<i class="fa fa-sort-<?php echo ($sort['white_date'] == 'asc') ? 'desc' : 'asc'; ?>"></i></a></td>
