...
<div class="tableWrapper" style="margin-bottom: 20px">
	<div class="tableHeader">
		<a style="background: #2f3640 !important; border-bottom: 2px #718093 solid !important;" href="<?php echo site_url('assessment/export_excel');?>" class="btnBlue"><i class="fa fa-download"></i> Export</a>
		<form method="POST">
			...
			?>
				<tr>
					...
					<td class="actionBlock">
						<a target="_blank" href="<?php echo site_url('assessment/form_assessment/'.$value['id'].'/'.$value['id_vendor'])?>" class="editBtn"><i class="fa fa-search"></i>&nbsp;Lihat</a>
					</td>
					<?php }?>
				</tr>
			<?php 
