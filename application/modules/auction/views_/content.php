			...
			?>
				<tr>
					...
					<td class="actionBlock">
						...
						<a href="<?php echo site_url('auction/report/index/internal/'.$value['id'])?>" class="editBtn">
							<i class="fa fa-file-text-o"></i>&nbsp;Laporan Internal
						</a> | 
						<a href="<?php echo site_url('auction/report/index/eksternal/'.$value['id'])?>" class="editBtn">
