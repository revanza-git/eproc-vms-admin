			...
			<tr class="input-form">
				...
				<td>
					<div class="clearfix">
						...
						<label class="lbform">
							<?php echo form_radio(array('name'=>'auction_type'),'forward_auction',set_radio('auction_type','forward_auction')||((isset($auction_type)?$auction_type:$this->form->get_temp_data('auction_type'))=='forward_auction'))?>Forward Auction
						</label>
					</div>
